...
|---|---|---|---|---|---|---|
| C1.1 | Minimum-representative quotient-poset count | PROVED; END-TO-END LEAN/KERNEL PASS | combinatorial proof + exact `native_decide` enumeration + literal-code equivalence + module-sharded `leanchecker` replay | formalization complete for the declared MF-R008 code/count claim | novelty not certified | none for the declared counting theorem; novelty remains separate |

...
No public software/content license has been selected in this package. See `LICENSE_NOTICE.md` before publishing. Choose a license deliberately and replace that notice if public reuse is intended.

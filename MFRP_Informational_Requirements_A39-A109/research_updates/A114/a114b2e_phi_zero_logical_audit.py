...
checks={
 ...
 'source_box_reproved_at_equality':'9/1000}<Q:=' in TH and '<\\frac1{25}' in TH,
 ...
 'p0_exact_elimination_present':'S_{\\gamma+}^C\n=\\frac{B_0-B_1p_0}{K_\\beta}' in TH,

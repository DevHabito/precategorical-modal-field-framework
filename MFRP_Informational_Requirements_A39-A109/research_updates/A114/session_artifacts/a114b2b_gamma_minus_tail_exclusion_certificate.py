...
out={
 ...
 'bridge_A':{'margin':str(bridge_A_margin),'margin_decimal':float(bridge_A_margin),'gates':bridge_A_gates,
             'dependency':'uses the already-audited A112-A V2 cofactor/remainder caps; 1e-70 is a conservative aggregate cap'},

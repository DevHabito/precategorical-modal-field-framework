...
PR=Path('/mnt/data/A109_H14_PREREGISTRATION.json'); EXPECTED='10900de0f0405a1f8db1f8af9c917fd042bdc6a9dad75507d3a7034622478320'
...
def main():
 ...
 if failures: verdict='REFUTED_A109_H14_TWO_SIDED_RULE'
 else: verdict='PASS_A109_H14_TWO_SIDED_HOLDOUT'
 res={'audit':'A109_H14_UNCHANGED_TWO_SIDED_ADJACENT_BOUNDARY_HOLDOUT_SHARD','preregistration_sha256':sha(PR),'rank_range':[args.start,args.end],'verdict':verdict,

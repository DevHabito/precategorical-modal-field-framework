...
PR=Path('/mnt/data/A109_H8_PREREGISTRATION.json'); EXPECTED='3acf7079c7c150bc44e3cfb19fe6d4419394a561eebc850144a62de4906250de'
...
def main():
 ...
 if failures: verdict='REFUTED_A109_H8_TWO_SIDED_RULE'
 else: verdict='PASS_A109_H8_TWO_SIDED_HOLDOUT'
 res={'audit':'A109_H8_UNCHANGED_TWO_SIDED_ADJACENT_BOUNDARY_HOLDOUT_SHARD','preregistration_sha256':sha(PR),'rank_range':[args.start,args.end],'verdict':verdict,

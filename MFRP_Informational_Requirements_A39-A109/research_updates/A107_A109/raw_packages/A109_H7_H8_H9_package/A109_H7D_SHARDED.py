...
PR=Path('/mnt/data/A109_H7D_PREREGISTRATION.json'); PRSHA='7d7269e4680ba2b0227dba9afef266bfb1dca9cb60209dc68b8b50d91ded719f'
MAN=Path('/mnt/data/A109_H7D_EXECUTION_MANIFEST.json'); MANSHA='da4b7fd34567f40a131a0d3156871225e45328def5fb720975961cdef6327dcf'
...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('--rank',type=int,required=True,choices=[227,228]);ap.add_argument('--mode',choices=['core','direct'],required=True);ap.add_argument('--probe-index',type=int,default=-1);ap.add_argument('--out',required=True);a=ap.parse_args()

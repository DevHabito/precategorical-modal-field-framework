...
PR=Path('/mnt/data/A109_H9D_PREREGISTRATION.json'); PRSHA='d143f195ed509fdc16ba320e4c3a191447c0f6f88e28049d5081930257a379c4'
MAN=Path('/mnt/data/A109_H9D_EXECUTION_MANIFEST.json'); MANSHA='5c50a0f5a89390107f418aaf6f5c079758ea2163684ae8815c5cdda610a788f2'
...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('--rank',type=int,required=True,choices=[255,256,257,258,261,262,263,264,265,266,267,268]);ap.add_argument('--mode',choices=['core','direct'],required=True);ap.add_argument('--probe-index',type=int,default=-1);ap.add_argument('--out',required=True);a=ap.parse_args()

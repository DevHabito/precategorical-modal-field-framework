...
PR=Path('/mnt/data/A109_H4_PREREGISTRATION.json'); EXPECTED='804612fe7a9455b626721804b382f7a7e5dfb6e2fc29187ab3455e762bd77a3b'
...
def main():
 ...
 pr=json.loads(PR.read_text()); manifest=json.loads(Path('/mnt/data/A109_H4_EXECUTION_MANIFEST.json').read_text()); allowed=[tuple(x) for x in manifest['remaining_execution_subshards']]
 ...
 if failures: verdict='REFUTED_A109_H4_TWO_SIDED_RULE'
 else: verdict='PASS_A109_H4_TWO_SIDED_HOLDOUT'
 res={'audit':'A109_H4_UNCHANGED_TWO_SIDED_ADJACENT_BOUNDARY_HOLDOUT_SUBSHARD','preregistration_sha256':sha(PR),'rank_range':[args.start,args.end],'verdict':verdict,

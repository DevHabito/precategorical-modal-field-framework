...
PR=Path('/mnt/data/A109_H15_PREREGISTRATION.json'); EXPECTED='7c12da017762a0cef7733172991be68f3d621488dedf579be038abd3631d630b'
...
def main():
 ...
 if failures: verdict='REFUTED_A109_H15_TWO_SIDED_RULE'
 else: verdict='PASS_A109_H15_TWO_SIDED_HOLDOUT'
 res={'audit':'A109_H15_UNCHANGED_TWO_SIDED_ADJACENT_BOUNDARY_HOLDOUT_SHARD','preregistration_sha256':sha(PR),'rank_range':[args.start,args.end],'verdict':verdict,

...
PR=Path('/mnt/data/A109_H10_PREREGISTRATION.json'); EXPECTED='8d4444e53f594b29dbab84060d623525cf2922c5060e6aa9d9102e2b2ca2c555'
...
def main():
 ...
 if failures: verdict='REFUTED_A109_H10_TWO_SIDED_RULE'
 else: verdict='PASS_A109_H10_TWO_SIDED_HOLDOUT'
 res={'audit':'A109_H10_UNCHANGED_TWO_SIDED_ADJACENT_BOUNDARY_HOLDOUT_SHARD','preregistration_sha256':sha(PR),'rank_range':[args.start,args.end],'verdict':verdict,

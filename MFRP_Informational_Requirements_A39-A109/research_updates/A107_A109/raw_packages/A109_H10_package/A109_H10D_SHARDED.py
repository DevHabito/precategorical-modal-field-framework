...
PR=Path('/mnt/data/A109_H10D_PREREGISTRATION.json'); PRSHA='e545aec22d76b989732da4505988d1be316ad3115116365aecf2ae61cbbcb836'
MAN=Path('/mnt/data/A109_H10D_EXECUTION_MANIFEST.json'); MANSHA='cf6aaf3ee7325f161d7708e3cfb00272162323717f1a5b0abaa75d7fd805344d'
...
def main():
    ap=argparse.ArgumentParser();ap.add_argument('--rank',type=int,required=True,choices=[273,274,277,278,283,284]);ap.add_argument('--mode',choices=['core','direct'],required=True);ap.add_argument('--probe-index',type=int,default=-1);ap.add_argument('--out',required=True);a=ap.parse_args()

...
PR=Path('/mnt/data/A109_H10D_PREREGISTRATION.json'); EXPECTED='e545aec22d76b989732da4505988d1be316ad3115116365aecf2ae61cbbcb836'
...
def main():
    ...
    if exact: verdict='REFUTED_OR_FAILED_A109_H10D_CERTIFICATE'
    elif unresolved: verdict='INCONCLUSIVE_A109_H10D_CERTIFICATE'
    else: verdict='RESOLVED_SUPPORT_A109_H10D_CERTIFICATE'

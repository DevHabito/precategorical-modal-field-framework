...
PR=Path('/mnt/data/A109_PREREGISTRATION.json'); EXPECTED='67b286eb336f2cc5ea5831fe4531368d3e36147befa7aefd0a61d7e3feb55829'
...
def main():
 ...
 if failures: verdict='REFUTED_A109_TWO_SIDED_RULE'
 else: verdict='PASS_A109_TWO_SIDED_HOLDOUT'
 res={'audit':'A109_TWO_SIDED_ADJACENT_BOUNDARY_HOLDOUT_SHARD','preregistration_sha256':sha(PR),'rank_range':[args.start,args.end],'verdict':verdict,

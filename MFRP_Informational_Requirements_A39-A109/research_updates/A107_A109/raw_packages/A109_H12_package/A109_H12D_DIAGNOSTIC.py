...
PR=Path('/mnt/data/A109_H12D_PREREGISTRATION.json'); EXPECTED='e6e337b1dd2c94565607bc99082f6e223fb1ab7e42c17eddf442c8c01afdff2a'
...
def main():
    ...
    if exact: verdict='REFUTED_OR_FAILED_A109_H12D_CERTIFICATE'
    elif unresolved: verdict='INCONCLUSIVE_A109_H12D_CERTIFICATE'
    else: verdict='RESOLVED_SUPPORT_A109_H12D_CERTIFICATE'

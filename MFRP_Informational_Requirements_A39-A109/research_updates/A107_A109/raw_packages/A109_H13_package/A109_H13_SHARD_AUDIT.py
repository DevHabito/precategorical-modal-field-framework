...
PR=Path('/mnt/data/A109_H13_PREREGISTRATION.json'); EXPECTED='24f6ab5bf007089a1c7b04260010406835bd1b9f6bc23ef3ffe0e5af4bedf11a'
...
def main():
 ...
 if failures: verdict='REFUTED_A109_H13_TWO_SIDED_RULE'
 else: verdict='PASS_A109_H13_TWO_SIDED_HOLDOUT'
 res={'audit':'A109_H13_UNCHANGED_TWO_SIDED_ADJACENT_BOUNDARY_HOLDOUT_SHARD','preregistration_sha256':sha(PR),'rank_range':[args.start,args.end],'verdict':verdict,

...
PREREG=Path('/mnt/data/A108_P2_PREREGISTRATION.json')
EXPECTED='66f8bb6cd01efafbee1da7ffabd044b85d08ae530aa994dc4f7fddaadb7012c6'
OUT=Path('/mnt/data/A108_P2_RESULT.json')
...
def main():
    ...
    for rank,record in enumerate(batch,start=42):
        t=time.time()
    ...
    if exact_failures: verdict='REFUTED_A108_P2'
    elif inconclusive: verdict='INCONCLUSIVE_A108_P2'
    else: verdict='PASS_SUFFICIENT_CERTIFICATE_HOLDOUT'
    result={'audit':'A108-P2_NON_TARGET_POSITIVITY_HOLDOUT','preregistration_sha256':sha(PREREG),'verdict':verdict,
            ...
            'scope':{'claim':'finite prospective sufficient-certificate holdout on canonical gamma-plus ranks 42..49','nonclaims':pp['nonclaims']}}

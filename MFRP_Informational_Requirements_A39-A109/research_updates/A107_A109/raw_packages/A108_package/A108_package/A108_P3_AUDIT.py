...
PREREG=Path('/mnt/data/A108_P3_PREREGISTRATION.json')
EXPECTED='1038a3a6b75907ba1467b356b2ad6964770b5219d3d9ba39abf97386bf8b3a1a'
OUT=Path('/mnt/data/A108_P3_RESULT.json')
...
def main():
    ...
    for rank,record in enumerate(batch,start=50):
        t=time.time()
    ...
    if exact_failures: verdict='REFUTED_A108_P3'
    elif inconclusive: verdict='INCONCLUSIVE_A108_P3'
    else: verdict='PASS_SUFFICIENT_CERTIFICATE_HOLDOUT'
    result={'audit':'A108-P3_UNCHANGED_SUFFICIENT_CERTIFICATE_REPLICATION','preregistration_sha256':sha(PREREG),'verdict':verdict,
            ...
            'scope':{'claim':'finite prospective unchanged sufficient-certificate replication on canonical gamma-plus ranks 50..65','nonclaims':pp['nonclaims']}}

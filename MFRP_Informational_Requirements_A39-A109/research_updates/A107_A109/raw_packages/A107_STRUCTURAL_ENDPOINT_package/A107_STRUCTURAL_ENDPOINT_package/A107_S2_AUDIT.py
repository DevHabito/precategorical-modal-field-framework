...
EXPECTED_PREREG_SHA256='2d396e190e17331b993c687a8c1ad73442f04b212eae23f2d8557fda760398dd'
DEFAULT_PREREG=Path('/mnt/data/A107_S2_PREREGISTRATION.json')
DEFAULT_OUT=Path('/mnt/data/A107_S2_RESULT.json')
...
def main():
    ...
    try:
        ...
        for rank,record in enumerate(batch,start=34):
    ...
    result={
        'audit':'A107-S2_UNCHANGED_STRUCTURAL_ENDPOINT_SIGN_HOLDOUT',
        'preregistration':{'path':str(prereg),'sha256':ph,'expected_sha256':EXPECTED_PREREG_SHA256,'hash_match':ph==EXPECTED_PREREG_SHA256},
        'selection':{'canonical_ranks':list(range(34,42)),'batch_size':8,'source_gamma_plus_count':len(source)},
        'summary':{
        ...
        'records':outputs,
        'scope':{
            'claim':'prospective holdout test of the exact lower-endpoint sign predictor on canonical gamma-plus ranks 34..41',
